...
\cventry{\ru{с}\en{since} 2022}{%
 ...
 \ru{Разработка ПО для выполнения расчётов в области геофизики с переносом части вычислений на видеокарту (\href{https://forctool.com/}{\textbf{forctool.com}}).}%
 \en{Developing software for scientific research using GPU computing (\href{https://forctool.com/}{\textbf{forctool.com}}).}%
}
...
\cvitem{\textcolor{color1}{\selectiontext{\ru{Языки программирования}\en{Programming languages}: }{\faCode}}}{%
  \textbf{C/C++} (STL, OpenCL, Qt), \textbf{Python} (NumPy, Tensorflow, PyTorch, Cython, Dask), Javascript/Typescript, Bash; \ru{также знаком с}\en{also familiar with} Java, x86 Assembly, Haskell, SQL.
}
...
\cvitem{\textcolor{color1}{\selectiontext{\ru{Знания}\en{Knowledge}: }{\faLightbulb}}}{%
  \ru{Алгоритмы и структуры данных, многопоточное программирование, машинное обучение, нейронные сети.}%
  \en{Algorithms and data structures, multithreading, machine learning and neural networks.}%
}
